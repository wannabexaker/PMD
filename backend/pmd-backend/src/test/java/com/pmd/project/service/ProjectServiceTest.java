...
class ProjectServiceTest {
    ...
    private MentionPolicyService mentionPolicyService;
    ...
    void setUp() {
        ...
        mentionNotificationService = mock(MentionNotificationService.class);
        mentionPolicyService = mock(MentionPolicyService.class);
